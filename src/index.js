...
router.get('/entities', await getAll(Entity, {include: [Feature, Proyect]}))
router.get('/entities/:id', await getUnique(Entity, {include: [Feature, Proyect]}))
...
router.get('/features', await getAll(Feature, {include: Entity}))
router.get('/features/:id', await getUnique(Feature, {include: Entity}))
